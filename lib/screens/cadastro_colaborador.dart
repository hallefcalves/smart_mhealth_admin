...
class Cadastro_colaborador extends StatelessWidget {
  const Cadastro_colaborador({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          ElevatedButton(
            onPressed: () => {Navigator.of(context).pushNamed('/colaboradores')},
            style: ElevatedButton.styleFrom(
              primary: MyTheme.defaultTheme.primaryColor,
              minimumSize: const Size(80, 40),
              maximumSize: const Size(80, 40),
