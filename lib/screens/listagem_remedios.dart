...
class Listagem_remedios extends StatelessWidget {
  const Listagem_remedios({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          ElevatedButton(
            onPressed: () => {Navigator.of(context).pushNamed('/cadastro_remedio')},//ver infos
          ...
          ElevatedButton(
            onPressed: () => {Navigator.of(context).pushNamed('/cadastro_remedio')},
            style: ElevatedButton.styleFrom(
              primary: MyTheme.defaultTheme.primaryColor,
              minimumSize: const Size(80, 40),
              maximumSize: const Size(80, 40),
